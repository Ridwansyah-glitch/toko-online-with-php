    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Wan Shop</a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;">  <a href="index.php?halaman=logout" class="btn btn-danger square-btn-adjust" onclick="return confirm('Yakin Logout')"><i class="fa fa-sign-out "></i> Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a  href="index.php?halaman=kategori"><i class="fa fa-file"></i> Kategori</a></li>
                    ...
                    <li><a  href="index.php?halaman=logout"  onclick="return confirm('Yakin Logout')"><i class="fa fa-sign-out " ></i> Logout</a></li>
                </ul>
            </div>
